...
--
-- 資料表結構 `ihealth_assets`
--

CREATE TABLE IF NOT EXISTS `ihealth_assets` (
...
--
-- 資料表的匯出資料 `ihealth_assets`
--

INSERT INTO `ihealth_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- 資料表結構 `ihealth_associations`
--

CREATE TABLE IF NOT EXISTS `ihealth_associations` (
...
--
-- 資料表結構 `ihealth_banners`
--

CREATE TABLE IF NOT EXISTS `ihealth_banners` (
...
--
-- 資料表結構 `ihealth_banner_clients`
--

CREATE TABLE IF NOT EXISTS `ihealth_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- 資料表結構 `ihealth_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `ihealth_banner_tracks` (
...
--
-- 資料表結構 `ihealth_categories`
--

CREATE TABLE IF NOT EXISTS `ihealth_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `ihealth_categories`
--

INSERT INTO `ihealth_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- 資料表結構 `ihealth_contact_details`
--

CREATE TABLE IF NOT EXISTS `ihealth_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- 資料表結構 `ihealth_content`
--

CREATE TABLE IF NOT EXISTS `ihealth_content` (
...
--
-- 資料表結構 `ihealth_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `ihealth_contentitem_tag_map` (
...
--
-- 資料表結構 `ihealth_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `ihealth_content_frontpage` (
...
--
-- 資料表結構 `ihealth_content_rating`
--

CREATE TABLE IF NOT EXISTS `ihealth_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- 資料表結構 `ihealth_content_types`
--

CREATE TABLE IF NOT EXISTS `ihealth_content_types` (
...
--
-- 資料表的匯出資料 `ihealth_content_types`
--

INSERT INTO `ihealth_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- 資料表結構 `ihealth_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `ihealth_core_log_searches` (
...
--
-- 資料表結構 `ihealth_extensions`
--

CREATE TABLE IF NOT EXISTS `ihealth_extensions` (
...
--
-- 資料表的匯出資料 `ihealth_extensions`
--

INSERT INTO `ihealth_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"14cc1b9082240bfc129e25e3d0e94435"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- 資料表結構 `ihealth_finder_filters`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_filters` (
...
--
-- 資料表結構 `ihealth_finder_links`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links` (
...
--
-- 資料表結構 `ihealth_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms0` (
...
--
-- 資料表結構 `ihealth_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `ihealth_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- 資料表的匯出資料 `ihealth_finder_taxonomy`
--

INSERT INTO `ihealth_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- 資料表結構 `ihealth_finder_terms`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_terms` (
...
--
-- 資料表結構 `ihealth_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- 資料表的匯出資料 `ihealth_finder_terms_common`
--

INSERT INTO `ihealth_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- 資料表結構 `ihealth_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- 資料表結構 `ihealth_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- 資料表結構 `ihealth_finder_types`
--

CREATE TABLE IF NOT EXISTS `ihealth_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表結構 `ihealth_languages`
--

CREATE TABLE IF NOT EXISTS `ihealth_languages` (
...
--
-- 資料表的匯出資料 `ihealth_languages`
--

INSERT INTO `ihealth_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
CREATE TABLE IF NOT EXISTS `ihealth_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `ihealth_menu`
--

INSERT INTO `ihealth_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- 資料表結構 `ihealth_menu_types`
--

CREATE TABLE IF NOT EXISTS `ihealth_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `ihealth_menu_types`
--

INSERT INTO `ihealth_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_messages`
--

CREATE TABLE IF NOT EXISTS `ihealth_messages` (
...
--
-- 資料表結構 `ihealth_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `ihealth_messages_cfg` (
...
--
-- 資料表結構 `ihealth_modules`
--

CREATE TABLE IF NOT EXISTS `ihealth_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- 資料表的匯出資料 `ihealth_modules`
--

INSERT INTO `ihealth_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- 資料表結構 `ihealth_modules_menu`
--

CREATE TABLE IF NOT EXISTS `ihealth_modules_menu` (
...
--
-- 資料表的匯出資料 `ihealth_modules_menu`
--

INSERT INTO `ihealth_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- 資料表結構 `ihealth_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `ihealth_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表結構 `ihealth_overrider`
--

CREATE TABLE IF NOT EXISTS `ihealth_overrider` (
...
--
-- 資料表結構 `ihealth_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `ihealth_postinstall_messages` (
...
--
-- 資料表的匯出資料 `ihealth_postinstall_messages`
--

INSERT INTO `ihealth_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- 資料表結構 `ihealth_redirect_links`
--

CREATE TABLE IF NOT EXISTS `ihealth_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表結構 `ihealth_schemas`
--

CREATE TABLE IF NOT EXISTS `ihealth_schemas` (
...
--
-- 資料表的匯出資料 `ihealth_schemas`
--

INSERT INTO `ihealth_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.1');

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_session`
--

CREATE TABLE IF NOT EXISTS `ihealth_session` (
...
--
-- 資料表的匯出資料 `ihealth_session`
--

INSERT INTO `ihealth_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('86h00dro3q1on23f0tlvijhs55', 1, 0, '1388972517', '__default|a:8:{s:15:"session.counter";i:14;s:19:"session.timer.start";i:1388972467;s:18:"session.timer.last";i:1388972516;s:17:"session.timer.now";i:1388972517;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:16:"com_joomlaupdate";O:8:"stdClass":3:{s:4:"file";N;s:8:"password";s:32:"mRI0e55baACpaIBGNJki7uf0ZKC1gbMF";s:8:"filesize";i:995551;}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"728";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:24:"aniki_wayne@yahoo.com.tw";s:8:"password";s:60:"$2y$10$Wt7ONmjRwCGu7OE3pzlPLeGMkxRCsZGLjMB/24xVtP7l5WkEJBkgS";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-01-06 01:40:44";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:2:"{}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:1:{i:0;s:28:"User not Super Administrator";}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"76689e38dc29484e58d4c5c2a8001016";}', 728, 'admin'),
('q9mt90b9kv593vktippnd2ki84', 0, 1, '1388972459', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1388972458;s:18:"session.timer.last";i:1388972458;s:17:"session.timer.now";i:1388972458;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:2:"13";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:1:{i:0;s:1:"1";}s:14:"\\0\\0\\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"d3feacb5360f2d3fdf672bdf57bf5f32";}', 0, '');
...
CREATE TABLE IF NOT EXISTS `ihealth_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- 資料表的匯出資料 `ihealth_tags`
--

INSERT INTO `ihealth_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_template_styles`
--

CREATE TABLE IF NOT EXISTS `ihealth_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `ihealth_template_styles`
--

INSERT INTO `ihealth_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- 資料表結構 `ihealth_ucm_base`
--

CREATE TABLE IF NOT EXISTS `ihealth_ucm_base` (
...
--
-- 資料表結構 `ihealth_ucm_content`
--

CREATE TABLE IF NOT EXISTS `ihealth_ucm_content` (
...
--
-- 資料表結構 `ihealth_ucm_history`
--

CREATE TABLE IF NOT EXISTS `ihealth_ucm_history` (
...
--
-- 資料表結構 `ihealth_updates`
--

CREATE TABLE IF NOT EXISTS `ihealth_updates` (
...
--
-- 資料表的匯出資料 `ihealth_updates`
--

INSERT INTO `ihealth_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
(2, 3, 0, 'Malay', '', 'pkg_ms-MY', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/ms-MY_details.xml', ''),
...
(5, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', ''),
...
(11, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', ''),
...
(16, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', ''),
...
(20, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
...
(25, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(26, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.2.1.0', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(27, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(28, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(29, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(30, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(31, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(32, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.2.1.3', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(33, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
...
(36, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(37, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(38, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
...
(42, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(43, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(44, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(45, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(46, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(47, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', ''),
(48, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(49, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', ''),
(50, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '');

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_update_sites`
--

CREATE TABLE IF NOT EXISTS `ihealth_update_sites` (
...
--
-- 資料表的匯出資料 `ihealth_update_sites`
--

INSERT INTO `ihealth_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1388972497),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1388972497),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1388972497);

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `ihealth_update_sites_extensions` (
...
--
-- 資料表的匯出資料 `ihealth_update_sites_extensions`
--

INSERT INTO `ihealth_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- 資料表結構 `ihealth_usergroups`
--

CREATE TABLE IF NOT EXISTS `ihealth_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- 資料表的匯出資料 `ihealth_usergroups`
--

INSERT INTO `ihealth_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
CREATE TABLE IF NOT EXISTS `ihealth_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- 資料表的匯出資料 `ihealth_users`
--

INSERT INTO `ihealth_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(728, 'Super User', 'admin', 'aniki_wayne@yahoo.com.tw', '$2y$10$lY/xUt7n4IIFkdwkqXB8NOgdIfkZXi8C3iZw8USYPmGwxKfXNk7J.', 0, 1, '2014-01-06 01:40:44', '2014-01-06 01:41:15', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_user_keys`
--

CREATE TABLE IF NOT EXISTS `ihealth_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表結構 `ihealth_user_notes`
--

CREATE TABLE IF NOT EXISTS `ihealth_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- 資料表結構 `ihealth_user_profiles`
--

CREATE TABLE IF NOT EXISTS `ihealth_user_profiles` (
...
--
-- 資料表結構 `ihealth_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `ihealth_user_usergroup_map` (
...
--
-- 資料表的匯出資料 `ihealth_user_usergroup_map`
--

INSERT INTO `ihealth_user_usergroup_map` (`user_id`, `group_id`) VALUES
(728, 8);

-- --------------------------------------------------------

--
-- 資料表結構 `ihealth_viewlevels`
--

CREATE TABLE IF NOT EXISTS `ihealth_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- 資料表的匯出資料 `ihealth_viewlevels`
--

INSERT INTO `ihealth_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- 資料表結構 `ihealth_weblinks`
--

CREATE TABLE IF NOT EXISTS `ihealth_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
